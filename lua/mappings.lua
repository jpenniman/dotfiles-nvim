...
require("mappings-fzflua")(map, opts)
require("mappings-lsp")(map, opts)
require("mappings-dap")(map, opts)
require("mappings-neotest")(map, opts)
require("mappings-ramboe-utils")(map, opts)
